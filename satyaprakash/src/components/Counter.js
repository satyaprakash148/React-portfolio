          ...
          <div className="row">
            <div className="col-sm-3 col-lg-3">
              <div className="counter-box counter-box pt-4 pt-md-0">
                ...
                <div className="counter-num">
                  <p data-purecounter-start="0" data-purecounter-end="450" data-purecounter-duration="0" className="counter purecounter">450</p>
            ...
            <div className="col-sm-3 col-lg-3">
              <div className="counter-box pt-4 pt-md-0">
                ...
                <div className="counter-num">
                  <p data-purecounter-start="0" data-purecounter-end="25" data-purecounter-duration="0" className="counter purecounter">25</p>
            ...
            <div className="col-sm-3 col-lg-3">
              <div className="counter-box pt-4 pt-md-0">
                ...
                <div className="counter-num">
                  <p data-purecounter-start="0" data-purecounter-end="550" data-purecounter-duration="0" className="counter purecounter">1</p>
            ...
            <div className="col-sm-3 col-lg-3">
              <div className="counter-box pt-4 pt-md-0">
                ...
                <div className="counter-num">
                  <p data-purecounter-start="0" data-purecounter-end="48" data-purecounter-duration="0" className="counter purecounter">48</p>
